...
AVRDUDE_ARDUINO_FLAGS = -p $(MCU) -c arduino -b 115200 -P $(SERIALPORT)
AVRDUDE_ARDUINO_FLAGS += $(AVRDUDE_NO_VERIFY)
AVRDUDE_ARDUINO_FLAGS += $(AVRDUDE_VERBOSE)
AVRDUDE_ARDUINO_FLAGS += $(AVRDUDE_ERASE_COUNTER)
